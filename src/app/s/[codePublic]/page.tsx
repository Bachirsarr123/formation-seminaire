      ...
      <CartePublique>
        ...
        {seminaire.formateurs.length > 0 ? (
          <section aria-label="Formateurs">
            <h2 className="text-[length:var(--taille-md)] mb-2 text-[color:var(--gris-900)]">Formateurs</h2>
        ...
        {seminaire.modules.length > 0 ? (
          <section aria-label="Programme">
            <h2 className="text-[length:var(--taille-md)] mb-2 text-[color:var(--gris-900)]">Programme</h2>
...
function EtatInscription({
  ...
  if (etat === 'OUVERTE') {
    return (
      <Link
        ...
        className="flex min-h-[56px] w-full items-center justify-center rounded-[var(--rayon-md)] bg-[color:var(--couleur-accent)] px-6 text-[length:var(--taille-md)] font-semibold text-[color:var(--couleur-accent-contraste)]"
      >
        Je m&apos;inscris
      </Link>
    );
  ...
  if (etat === 'TERMINE') {
    return <p className="text-[color:var(--gris-600)]">Ce séminaire est terminé.</p>;
  }

  if (etat === 'FERMEES') {
    return <p className="text-[color:var(--gris-600)]">Les inscriptions pour ce séminaire sont fermées.</p>;
  }

  return <p className="text-[color:var(--gris-600)]">Les inscriptions ne sont pas ouvertes pour le moment.</p>;
}
